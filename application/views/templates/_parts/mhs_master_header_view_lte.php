        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?php echo strtoupper($user->username);?></span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo site_url('mahasiswa/user/profile');?>" class="btn btn-default btn-flat">Profile</a>
                </div>
				<div class="pull-right">
                  <a href="<?php echo site_url('mahasiswa/user/logout');?>" class="btn btn-danger btn-flat">LogOut</a>
                </div>
              </li>
            </ul>
          </li>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="<?php echo (($menu_data['transaksi']=='true')? 'active':'') ?> treeview">
          ...
          <ul class="treeview-menu">
            <li class="" id="menuDaftarPraktikum"><a href="<?php echo site_url('mahasiswa/daftar_praktikum');?>"><i class="fa fa-circle-o "></i> Daftar Praktikum</a> </li>
            <li class="" id="menuAbsensiPraktikum"><a href="<?php echo site_url('mahasiswa/absensi_online');?>"><i class="fa fa-circle-o "></i> Absensi Praktikum</a> </li>
            <li class="" id="menuNilaiPraktikum"><a href="<?php echo site_url('mahasiswa/nilai_praktikum');?>"><i class="fa fa-circle-o "></i> Nilai Praktikum</a> </li>
          </ul>
        </li>
